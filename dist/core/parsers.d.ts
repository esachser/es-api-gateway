...
export declare function decodeToObject(data: NodeJS.ReadableStream | Buffer | undefined, ...parsersDefs: Array<{
    parser: string;
    opts?: any;
}>): Promise<any>;
export declare function encodeToStream(data: NodeJS.ReadableStream | Buffer | undefined, ...parsersDefs: Array<{
    parser: string;
    opts?: any;
