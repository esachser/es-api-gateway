        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, promises_1.default.readFile(configFileName)];
                case 1:
                    text = _a.sent();
...
fs_1.default.watch(configFileName, function (event, fname) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
